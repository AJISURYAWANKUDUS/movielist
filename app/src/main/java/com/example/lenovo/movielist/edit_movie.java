...
public class edit_movie extends AppCompatActivity {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (title2.isEmpty()&&overview2.isEmpty()&&release_date2.isEmpty()){
                    ...
                    edit_data(title2,overview2,release_date2);
                }
            }
        });
    }
    ...
    private void edit_data(String title2, String overview2, String release_date2) {
        RequestQueue requestQueue = Volley.newRequestQueue(edit_movie.this);
        Log.d("url", "login_process: "+config_url.url+ "edit_movie.php?title=" + title2 + "&overview=" + overview2+"&release_date="+release_date2);
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, config_url.url + "edit_movie.php?title=" + title2 + "&overview=" + overview2+"&release_date="+release_date2, null, new Response.Listener<JSONObject>() {
            @Override
